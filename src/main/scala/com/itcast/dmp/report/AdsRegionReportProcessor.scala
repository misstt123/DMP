...
object AdsRegionReportProcessor extends ReportProcessor {
  ...
  override def sourceTableName: String = ETLRunner.ODS_TABLE_NAME

  override def targetTableName: String = "report_ads_region_" + KuduHelper.formattedDate()
  ...
  override def targetTableKeys: List[String] = List("region","city")
}